...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define AHT20_ADDRESS 0x38 << 1 // Use 8-bit slave address
...
int main(void)
{
  ...
  HAL_Delay(100);
//  if (HAL_I2C_IsDeviceReady(&hi2c1, AHT20_ADDRESS, 1, 100) == HAL_OK)
//  {
////	  sprintf((char*)msg, "Successfully communicated with I2C\r\n");
